...
USERSTABLE;
    ...
    if (isset($_GET["addUserForm"])){
      echo <<< ADDUSERFORM
        ...
        <input type="text" name="firstName" placeholder="Podaj Imie"><br><br>
        <input type="text" name="lastName"placeholder="Podaj Nazwisko"><br><br><select name="city_id">
ADDUSERFORM;
...
ADDUSERFORM;
      ...
      echo '<a href="./3_db_table.php?addUserForm=1">Dodaj użytkownika</a>';
    }
